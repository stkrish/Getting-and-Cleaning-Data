...
* tidydata1.csv - 10299 rows and 81 cols
* tidydata2.csv - 180 rows and 81 cols

### Include dataset
The data is located in the results folder

tidydata1 <- read.csv("results/tidydata1.csv")
tidydata2 <- read.csv("results/tidydata2.csv")
